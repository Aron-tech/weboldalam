<div class="relative flex justify-center items-center overflow-hidden">
    <!-- Kártyák konténer -->
    <div class="flex transition-transform duration-500 transform w-full" id="card-container">

        <div class="bg-white/70 rounded-lg p-6 sm:p-10 text-center w-3/4 sm:w-1/3 flex-shrink-0 card" data-experience="3" data-start-year="2020">
