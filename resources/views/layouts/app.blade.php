...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>@yield('title') - Papp Áron</title>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Frank+Ruhl+Libre:wght@300..900&family=Roboto+Slab:wght@100..900&display=swap" rel="stylesheet">
    ...
    <body>
       ...
       <main>
            ...
            @if($settings['widget'])
                ...
                <script>
                    window.widgetConfig = {
                        siteId: 'O6ooY_DXyJv9XR6VVcwzOwcL',
                        widgetName: 'Segítségkérő',
                        };
                </script>
